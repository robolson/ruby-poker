...
By default ruby-poker will not raise an exception if you add the same card to a
hand twice. You can tell ruby-poker to not allow duplicates by doing the 
following
...
The original version of ruby-poker was written entirely by myself (Robert
Olson). As of the 0.2.0 release ruby-poker incorporates Patrick Hurley's Texas 
